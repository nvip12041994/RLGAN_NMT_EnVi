...
if __name__ == '__main__':    
    ...
    generator_option = ['v060_data-bin/iwslt15.tokenized.en-vi', '-a', 'transformer_iwslt_de_en', '--optimizer', 'adam', '--lr', '0.0005',
                        '-s' 'en', '-t' 'vi',   
    ...
    args = options.parse_args_and_arch(parser,generator_option)
    print(args.arch)
    print('--------------------------------')
